import { Badge, Button, Form, Popconfirm, Input, Table, message } from "antd";
import { useCallback, useEffect, useMemo, useState } from "react";
import './index.css';
import { ColumnsType } from "antd/es/table";
import { useForm } from "antd/es/form/Form";
import { meetingRoomList, deleteMeetingRoom } from "../../services/meeting";
import { Add } from "./add";
...
export function MeetingRoomManage() {
    ...
    return <div id="meetingRoomManage-container">
        ...
        <Add isOpen={isCreateModalOpen} handleClose={() => {
            setIsCreateModalOpen(false);
            setNum(Math.random())
        }}/>

        <Update id={updateId!} isOpen={isUpdateModalOpen} handleClose={() => {
